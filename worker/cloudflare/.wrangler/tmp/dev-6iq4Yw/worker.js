...
// .wrangler/tmp/bundle-giE0yH/checked-fetch.js
...
var worker_default = {
  async fetch(req, env) {
    ...
    try {
      ...
      const ctx = String(context).slice(0, 1e3);
      const sys = [
...
// .wrangler/tmp/bundle-giE0yH/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-giE0yH/middleware-loader.entry.ts
